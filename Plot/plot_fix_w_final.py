...
for row in ['A','B','C']:
    ...
    i = row + '1'
    # ==== Training Acc
    axes[i].plot(steps, acc_test['Wn'].values, label='Baseline')
    axes[i].plot(steps, acc_test['We1'].values, label='fixed W')
    ...
    i = row + '2'
    # ===== NC1
    axes[i].plot(steps, nc1['Wn'].values, label='Baseline')
    axes[i].plot(steps, nc1['We1'].values, label='fixed W')
    ...
    # ===== NC2
    i = row + '3'
    axes[i].plot(steps, nc3['Wn'].values, label='Baseline')
    axes[i].plot(steps, nc3['We1'].values, label='fixed W')
    ...
    i = row + '4'
    # ===== NC3
    axes[i].plot(steps, nc2['Wn'].values, label='Baseline')
    axes[i].plot(steps, nc2['We1'].values, label='fixed W')
