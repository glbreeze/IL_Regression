...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.max_epoch):
        ...
        nc_dt = {'lr': optimizer.param_groups[0]['lr'],
                 ...
                 'norm_w1': norm_W[0].item(),
                 'norm_w2': norm_W[1].item(),
                 'W_outer_d': W_outer_d}
        ...
        wandb.log(
            {'train/lr': optimizer.param_groups[0]['lr'],
             ...
             'W/cos_w12': cosine_W[0, 1].item(),
             'W/norm_w1': norm_W[0].item(),
             'W/norm_w2': norm_W[1].item(),
             'W/W_outer_d': W_outer_d
             },
            step=epoch)

        log('Epoch {}/{}, runnning train mse: {:.4f}, cos_w12: {:.4f}, norm_w1: {:.4f}, norm_w2: {:.4f}, W_outer_d: {:.4f}'.format(
            epoch, args.max_epoch, running_train_loss, cosine_W[0, 1].item(), norm_W[0].item(), norm_W[1].item(), W_outer_d
        ))
